    ...
    return res(
      ...
      ctx.json({
        ...
        googleReviews: [
          ...
          {
            like: false,
            text: '가성비 좋은 깔끔한 인테리어의 정육식당 해봉정육. 안창살, 토시살, 안심, 특수부의 모듬 모두 상당히 고퀄리티다. 특히 안창살이 좋았는데, 육향도 진하고 잡내없이 식감과 부드러움 그리고 육즙까지 모두 일품. 토시살은 안창살보단 약간 질긴 감이 있지만 나름대로의 맛이 좋다. 이 집의 불판은 무쇠 솥뚜껑을 뒤짚어 높은 스타일',
            name: '효f은',
            publishTime: new Date('2024-10-03T11:45:00Z'),
          },
          {
